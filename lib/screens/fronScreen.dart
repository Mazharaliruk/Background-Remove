...
class FronScreen extends StatefulWidget {
  const FronScreen({Key? key}) : super(key: key);

  @override
  State<FronScreen> createState() => _FronScreenState();
}

class _FronScreenState extends State<FronScreen> {
  XFile? _image;
