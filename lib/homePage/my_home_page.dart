...
import 'package:upload_images/screens/back_screen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final picker = ImagePicker();
   ...
   Future<void> removeBackground(String imgPath) async {
     ...
     buildButton({required String text,dynamic onPress,required bool isClick}){
       ...
       child: InkWell(
         ...
         child: Container(
           ...
           decoration: BoxDecoration(
             color: isClick?Colors.deepOrange:Colors.grey[200],
                    ...
                    Expanded(child:  buildButton(
                        ...
                        onPress: (){
                          ...
                          Navigator.push(context,
                            ...
                            PageRouteBuilder(
                              pageBuilder: (context,animation,secondaryAnimation)=>BackScreen(),
